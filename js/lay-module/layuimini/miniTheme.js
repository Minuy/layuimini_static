        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://www.runoob.com/" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 菜鸟教程</a>\n' +
                    '<a class="more-menu-item" href="http://cn.bing.com/" target="_blank"><i class="layui-icon layui-icon-search" style="font-size: 16px;"></i> 必应搜索</a>\n' +
                    '<a class="more-menu-item" href="http://i.mooc.chaoxing.com/" target="_blank"><i class="layui-icon layui-icon-rate"></i> 学习通</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
